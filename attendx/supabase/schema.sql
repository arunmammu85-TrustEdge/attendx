...
-- ── 11. System Settings (single-row config — run this migration) ───────────
CREATE TABLE IF NOT EXISTS system_settings (
  id                  INT  PRIMARY KEY DEFAULT 1,
  geofence_lat        FLOAT8,
  geofence_lon        FLOAT8,
  geofence_radius     INT     DEFAULT 500,
  geofence_location   TEXT,
  strict_geofence     BOOLEAN DEFAULT true,
  allow_wfh_global    BOOLEAN DEFAULT false,
  shift_start         TEXT    DEFAULT '09:00',
  shift_end           TEXT    DEFAULT '18:00',
  grace_minutes       INT     DEFAULT 15,
  halfday_hours       FLOAT4  DEFAULT 4.0,
  weekend_attendance  BOOLEAN DEFAULT false,
  face_enabled        BOOLEAN DEFAULT true,
  liveness_enabled    BOOLEAN DEFAULT true,
  test_mode           BOOLEAN DEFAULT false,
  face_threshold      FLOAT4  DEFAULT 0.42,
